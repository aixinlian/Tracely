...
- 🔍 **多仓库扫描** — 配置多个本地仓库,一键聚合时间范围内的全部提交与未提交改动
- 🤖 **AI 总结** — 兼容 OpenAI 接口(支持 OpenAI / DeepSeek / 通义 / Kimi / 本地 Ollama 等),自带 Key,零订阅成本
- 🗓️ **多周期报告** — 日报、周报、月报、年报,自动按对应时间范围聚合
- ✍️ **手动编辑** — 生成的是草稿,Markdown 编辑器随便改、随便补
- 📦 **导入导出** — 报告可导出为文件,也可批量导入,方便备份与迁移
- 📅 **本地归档** — 报告存本地数据库,可翻历史、随时回看
...
4. 在编辑器里调整、补充,保存归档。
5. 切换日报 / 周报 / 月报 / 年报周期,自动按对应时间范围聚合。
6. 在历史页回看过往报告,支持导入与导出备份。
